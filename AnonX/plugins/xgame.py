...
GAME_MESSAGE = "⩹━★⊷━⌞ѕᴏụʀᴄᴇ Ze⌝━⊶★━⩺\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب المرتجل\n\n⩹━★⊷━⌞ѕᴏụʀᴄᴇ Ze⌝━⊶★━⩺"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
        InlineKeyboardButton ('Ze', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('⌞ѕᴏụʀᴄᴇ Ze⌝⚡️', url =f"https://t.me/UI_XB")              
                 ],[
